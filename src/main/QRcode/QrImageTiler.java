...
import main.QRcode.TmpQr.testdelete.QrTilerbackup;
...
public class QrImageTiler extends JPanel {
...
//    class tableDataModel extends Abstract
        ...
        public QrImageTiler() throws Exception {
...
//                };
        ...
        public static void main (String[]args) throws Exception {
            SwingUtilities.invokeLater(new Runnable() {
                public void run() {
                    try {
                        new QrImageTiler().createAndShowGUI();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
